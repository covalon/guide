...
Items of Uncommon, Rare, or Unique rarity require staff permission before being dropped as loot. If you want to know if an item is approved to drop, check the crafting spreadsheet pinned in the [🛠️ The Crafting Hall](https://discord.com/channels/802423566196539412/1443090969749754029) channel to see if we have the formula already, or do a search in [\#💰loot-chat](https://discord.com/channels/802423566196539412/803177961817243649) to see if it's been dropped before. If it has, that item is OK to drop as loot.
