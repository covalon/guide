...
>
> In these cases you can use the [Building Creatures](https://2e.aonprd.com/Rules.aspx?ID=995) rules in order to create or scale a custom creature. There are similar rules for [Building Hazards](https://2e.aonprd.com/Rules.aspx?ID=1043). When doing so, please submit the full statblock as part of your approval.
