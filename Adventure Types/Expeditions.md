...
>
> If there is a particular expedition adventure you'd like to play in, you can always use [#🛡️lfgm-forum](https://discord.com/channels/802423566196539412/1472263264585908430) to create a party and request a Dungeon Guide to run the adventure for you. You can even choose which mission you'd like to play. Once Phase 2 has been unlocked for an expedition, three missions become available that are always referred to as Mission A, Mission B, and Mission C. Though the missions are all narratively linked, they can be experienced in any order, as they are not prequels or sequels to each other.
>
